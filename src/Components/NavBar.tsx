  ...
  return (
    <nav className="container flex items-center justify-between flex-wrap bg-white py-4 lg:px-12">
      <div className="flex justify-between lg:w-auto w-full lg:border-b-0 pl-6 pr-2  pb-5 lg:pb-0">
        ...
        <div className="ml-12">
        <button className="3xs:flex lg:hidden items-center justify-center text-[13px] w-[121px] inline-flex bg-transparent hover:bg-btn-pink hover:text-white  py-2 border border-btn-pink hover:border-transparent  focus:outline-none rounded-3xl">
              Download CV
            </button>
        </div>
        ...
        <div className={menuButtonClass}>
          <button
            id="nav"
            className="flex py-2 px-3 w-[50px] ml-[24px] -mt-[5px]"
